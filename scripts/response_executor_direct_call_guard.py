...
DOCUMENTED_ALLOWLIST = {
    ...
    "apps/tamandua_server/lib/tamandua_server/ai_security/response_actions.ex",
    ...
    "apps/tamandua_server/lib/tamandua_server_web/controllers/api/v1/ai_model_controller.ex",
