...
Report: `20260630T-ml-mirror-publication-audit-post-threshold-sync`
...
| tamandua-ml | `True` | `0` | `has_content` | `hold_do_not_push` |
| tamandua-mobile-app | `False` | `0` | `missing` | `not_ready` |
| tamandua-mobile-sdk | `False` | `0` | `missing` | `not_ready` |
...
- `ml_standalone_validation_defined`: `True` - Standalone validation is metadata/dry-run only: mirror publication audit, benchmark report contracts, ML-3 agent production-gap audit, and VX Underground inventory contracts. Experimental sequence heads remain UNTRAINED (501) and external wrappers stay fenced.
