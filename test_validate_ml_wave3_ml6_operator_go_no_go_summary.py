...
CANONICAL = ROOT / "docs" / "benchmarks" / "runs" / "20260604T-ml-wave3-ml6-operator-go-no-go-summary.json"
...
def test_validate_wave3_ml6_operator_go_no_go_summary_rejects_false_ready_claim(tmp_path: Path) -> None:
    ...
    drifted = tmp_path / "20260604T-ml-wave3-ml6-operator-go-no-go-summary.json"
